...
class Block:
    ...
    IStore transactions in a blockchain that supports a cryptocurrency
    """
    ...
    def mine_block(last_block, data):
        """
        Mine a block based on given last_block and data, until a block hash is found that meets the leading 0s proof of work requirement.
        """
